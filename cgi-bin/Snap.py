...
#     subprocess.call(cmd, shell=True)
    ...
    <body>
    <IMG SRC="/test.jpg" ALT="new photo" WIDTH="80%">
    <FORM METHOD="POST" ACTION="Snap.py"> 
    <button type="submit" name="Snap" value="Snap_btn_was_clicked" action="Snap.py" method="post">
